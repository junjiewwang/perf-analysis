...
//
// ## Utilities (util_*.go)
//   - util_bitset.go: Bitset type aliases (-> internal/collections)
//   - util_worker_pool.go: Worker pool aliases (-> internal/parallel)
//   - util_compression.go: Compression aliases (-> internal/compression)
